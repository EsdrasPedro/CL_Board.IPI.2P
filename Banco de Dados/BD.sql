...
CREATE TABLE CL_DISCIPLINA(
    ...
    CONSTRAINT DIS_CUR_PK FOREIGN KEY (CUR_ID) REFERENCES CL_CURSO (ID));
...
CREATE TABLE CL_DISCIPLINA_OFERTADA(
    ...
    CONSTRAINT DIO_USU_PK FOREIGN KEY (USU_ID_PROFESSOR) REFERENCES CL_USUARIO (ID));
...
CREATE TABLE CL_REUNIÃO_MARCADA(
    ...
    CONSTRAINT REU_DIO_PK FOREIGN KEY (DIO_ID) REFERENCES CL_DISCIPLINA_OFERTADA (ID));
    
CREATE TABLE CL_MATRICULA(
	USU_ID INT NOT NULL,
    DIO_ID INT NOT NULL,
    CONSTRAINT MA_USU_PK FOREIGN KEY (USU_ID) REFERENCES CL_USUARIO (ID),
    CONSTRAINT MA_DIO_PK FOREIGN KEY (DIO_ID) REFERENCES CL_DISCIPLINA_OFERTADA (ID));