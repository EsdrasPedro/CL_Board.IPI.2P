  ...
  <div class="app">
    ...
    <div class="bg-white rounded-lg shadow-sm p-5 ">
            ...
            <div class="task-input">
              ...
              <h4 class="mb-5 cc position-absolute top-10 start-0">Lista de Disciplinas Ofertadas</h4> 
              </div>
              ...
              <div class="task-tools">
                ...
                <div class="task-filters">
                  <a class="side-nav-menu-link media align-items-center" href="CL_disciplina_ofertada.php">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane fade show active task-list">
              ...
              <?php foreach($discsO as $discO): ?>
                <div class="cc justify-content-between align-items-center d-flex unfold-item task-item"><?=  $discO['NOME']  ?> - <?=  $discO['ANO']  ?> . <?=  $discO['SEMESTRE']  ?> 

                  <a class="unfold-link align-items-center text-nowrap task-delete" href="./Auth/Disciplina/delete.php?ID=<?= $discO['ID'] ?>">
