...
<body>
    <div class="app-container">
      ...
      <a href="Agenda.php" class="app-sidebar-link">
      ...
      <a href="Listar_Curso.php" class="app-sidebar-link active">
        ...
        <div class="projects-section">
                    ...
                    <div class="card-header p-0">
                        <ul id="wallets" class="nav nav-v2 nav-justified d-block d-xl-flex w-100" role="tablist">
                            <li class="nav-item border-xl-bottom-0 det">
                                <a class="nav-link align-items-center py-2 px-3" href="Listar_Curso.php" role="tab" aria-selected="true"
                                   data-toggle="tab">
                                    <span class="name1">Curso</span>
                                </a>
                            </li>
                            <li class="nav-item border-xl-bottom-0 border-xl-left det">
                                <a class="nav-link align-items-center py-2 px-3" href="Listar_Disciplina.php" role="tab" aria-selected="false"
                                   data-toggle="tab">
                                    <span class="name1">Disciplina</span>
                                </a>
                            </li>
                            <li class="nav-item border-xl-bottom-0">
                                <a class="nav-link align-items-center py-2 px-3" href="Listar_Disciplina_Ofertada.php" role="tab" aria-selected="false"
                                   data-toggle="tab">
                                    <span class="name">Disciplina Ofertada</span>
                                </a>
                            </li>
                            <li class="nav-item border-xl-bottom-0 det">
                                <a class="nav-link align-items-center py-2 px-3" href="Listar_Reuniao_Marcada.php" role="tab" aria-selected="false"
                                   data-toggle="tab">
                                    <span class="name1">Reunião Marcadas</span>
                                </a>
                            </li>
                        </ul>
                    </div>
          ...
          <div class="messages-section1">
            ...
            <div class="projects-section-header">
                <p>Cadastro de Disciplinas Ofertadas</p>
            </div>
            ...
            <div class="task-tools">
              ...
              <div>
                <button class="task-filter" data-param="completed" data-value="false">
                  <a href="CL_disciplina_ofertada.php" class="a1">
                    Cadastrar
                  </a>
                </button>
              </div>
              ...
              <div class="message-box">
                <div class="message-content">
                  <div class="message-header">
                    <div> <?=  $discO['NOME']  ?> - <?=  $discO['ANO']  ?> . <?=  $discO['SEMESTRE']  ?> </div>
                    <div class="star-checkbox">
                      <label class="star-1">
                        <a class="btn-logout" href="./Auth/Ofertado/Remove.php?ID=<?= $discO['ID'] ?>">
